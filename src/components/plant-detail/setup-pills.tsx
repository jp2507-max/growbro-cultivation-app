...
function Pill({
  ...
  return (
    <View className="flex-row items-center gap-2 rounded-full border border-border bg-white px-4 py-2 shadow-sm dark:border-dark-border dark:bg-dark-bg-elevated">
      {icon}
