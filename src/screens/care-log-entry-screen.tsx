              ...
              <View className="flex-row items-center justify-between pt-3">
                ...
                >
                  <X
                    size={18}
                    color={
                      isDark ? Colors.textPrimaryDark : Colors.textSecondary
                    }
                  />
                </Pressable>
              </View>
                    ...
                    >
                      ...
                      >
                        <OptionIcon
                          size={23}
                          color={
                            isSelected ? Colors.white : option.idleIconColor
                          }
                        />
                      </View>
                      <Text
              ...
              <View className="mt-7">
                ...
                <View className="mt-2 flex-row items-end gap-3">
                  <View className="flex-1">
                    ...
                    />
                    <View className="bg-border-light dark:bg-dark-border mt-1 h-0.5 rounded-full">
                      <View
                        className="h-0.5 rounded-full bg-primary dark:bg-primary-bright"
